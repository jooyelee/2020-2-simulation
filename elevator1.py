...
class lift:
    ...
    def switch(self):
        ...
        # 엘리베이터 안에 승객이 있거나 진행 방향 앞쪽에 요청이 있을 경우 방향 유지
...
def arrival(k):
    ...
    # 승객 생성
    if lift1.direction == 0 and lift1.floor == k:
    ...
    elif lift2.direction == 0 and lift2.floor == k:
