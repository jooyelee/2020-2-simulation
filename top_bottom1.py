...
f = open("log_위아래.txt", 'w')
result = open('result_위아래.txt','w')
# 같은 폴더에 파일 생성
class lift:
    def __init__(self):
        self.floor = 1
...
def arrival(k):
    ...
    # 승객 생성
    if lift1.direction == 0 and lift1.floor == k and goal in [1,2,3]:
    ...
    elif lift2.direction == 0 and lift2.floor == k and goal in [1,4,5]:
